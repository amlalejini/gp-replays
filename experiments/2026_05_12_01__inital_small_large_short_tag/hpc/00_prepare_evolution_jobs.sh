...
sed "s/(<EXP_SLUG>)/${EXP_SLUG}/g" 00_job_template_evolution.sb > out.sb
...
SLURM_FILENAME=${SCRATCH_SLURM_JOB_DIR}/${EXP_SLUG}__${TIMESTAMP}.sb
echo "Would have been moved to "
echo "${SLURM_FILENAME}"
