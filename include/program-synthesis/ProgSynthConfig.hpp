...
EMP_BUILD_CONFIG(ProgSynthConfig,
  ...
  VALUE(PHYLO_SNAPSHOTS, bool, true, "Should we output phylogeny snapshots?"),
  VALUE(PHYLO_SNAPSHOT_INTERVAL, size_t, 100, "How often should we snapshot?"),
  VALUE(RECORD_PHYLO_GENOTYPES, bool, false, "Output phylogeny genotypes when taking a phylogeny snapshot?"),
  VALUE(CURRENT_POP_GENOME_SNAPSHOTS, bool, false, "Output current full population"),
  VALUE(CURRENT_POP_SNAPSHOT_INTERVAL, size_t, 100, "How often to output a population snapshot?"),
