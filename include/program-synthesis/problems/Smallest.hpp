...
#include "psb/readers/Smallest.hpp"
#include "../TestResult.hpp"

namespace psynth::problems {

struct Smallest : public BaseProblem {
  using reader_t = psb::readers::Smallest;
  ...
  void InitTest(HARDWARE_T& hw, ORG_T& org, const test_case_t& test_io) {
    ...
    const size_t tag_w = HARDWARE_T::tag_t::GetCTSize();
    hw.QueueEvent(
